...
"""
x = [1, 2, 3, 4]
accuracy = [classification_accuracy,Sensitivity,Specificity,F_measure]# create figure and axis objects,fig, ax = plt.subplots()
fig, ax = plt.subplots()
ax.plot(x, accuracy)
ax.set_xlabel('Points')
ax.set_ylabel('Percentage')
ax.set_title('Accuracy precision recall true positive_rate specificity')
ax.legend()
plt.show()
"""
def fitness_function(params, X_train, y_train):
